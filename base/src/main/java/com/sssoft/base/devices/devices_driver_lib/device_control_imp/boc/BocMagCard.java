...
public class BocMagCard implements Card {

    private AidlCardReader iMagCardReader;
    private AidlSwiper swiper;
    private CardListener cardlistener;
    private int mTimeout;

    public BocMagCard(IBinder binder) {
        iMagCardReader = AidlCardReader.Stub.asInterface(binder);
    ...
    public void read(int timeout, CardListener listener) {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    iMagCardReader.openCardReader(Const.OpenCardType.MagicCard,
                            false,
                            false,
                            mTimeout * 1000,
